...
export default function IndustryNews() {
  return (
    <section className="section-industry-news mt-[50px] md:mt-[104px]">
      <div className="">
        <div className="title mb:text-center text-[45px] mb-[40px]">
          <div className="content-container mx-auto">
            <div className="flex justify-between">
              <div className="poppins-bold text-[1.5rem]">Recent <span className="text-blue">Industry News</span></div>
              <a href="/" title="Read more" className="poppins-bold text-xs md:text-[22px] text-blue font-bold flex items-center gap-[18px]">
                <span>Read more </span>
        ...
        <div className="content">
          <div className="content-container mx-auto">
            <div className="md:flex justify-between md:gap-[58px]">
              {
                [1,2,3].map(() => (
                  <div className="grow bg-gray rounded-[35px] shadow-[0px_2px_4px_rgba(0,0,0,0.25)] mb-4 p-[38px]">
